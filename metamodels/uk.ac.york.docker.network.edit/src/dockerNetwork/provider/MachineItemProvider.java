...
/**
 * This is the item provider adapter for a {@link dockerNetwork.Machine} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MachineItemProvider extends NamedItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DockerNetworkPackage.Literals.MACHINE__IP_ADDRESS,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DockerNetworkPackage.Literals.MACHINE__EXPOSED_PORTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DockerNetworkPackage.Literals.MACHINE__EXPOSED_PORTS,
				 DockerNetworkFactory.eINSTANCE.createPort()));
	}
